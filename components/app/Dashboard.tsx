...
import DeleteProjectModal from "@/components/app/projects/DeleteProjectModal";
        ...
        <>
          <nav className="mt-5 flex justify-end">
            <Link
              ...
              className="cursor-pointer rounded-xl border-2 border-fuchsia-500 bg-fuchsia-50 px-6 py-2 text-lg font-semibold text-fuchsia-500 uppercase transition hover:bg-fuchsia-500 hover:text-white disabled:opacity-50"
            >
              New Project
            </Link>
          </nav>
          ...
          <div className="mt-8 flex flex-col gap-3">
            {projects.map((project) => (
              <div
                key={project._id}
                className="flex justify-between gap-x-6 rounded-lg border border-zinc-200 bg-white p-6 shadow-md"
              >
